...
class Instrument(ABC):
    ...
    def __init__(self):
        ...
        self.uniform_sub_instrument_frame = self.sub_instruments[0].frame if self._universal_subinstrument_frame is None else self._universal_subinstrument_frame
